    ...
    <div className="col-span-12 space-y-4">
      ...
      {registrations.length > 0 && (
        <div className="flex flex-col sm:flex-row gap-3">
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '0 12px', background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 4, flex: 1, maxWidth: 384 }} className="focus-within:border-blue-500 focus-within:bg-white transition-colors">
