...
export const BlogTab: React.FC<BlogTabProps> = ({ onRunAiSeo }) => {
  ...
  return (
    <div className="space-y-5">
      ...
      {activeView === 'posts' && (
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '0 12px', background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 4, maxWidth: 384 }} className="focus-within:border-indigo-500 focus-within:bg-white transition-colors">
